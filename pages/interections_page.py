...
class SortablePage(BasePage):
    ...
    def change_list(self):
        ...
        elem = self.element_is_visible(self.locators.TAB_LIST)
        elem.click()
        order_defore = self.get_sortable_items(self.locators.LIST_ITEM)
    ...
    def change_grid_order(self):
        ...
        order_defore = self.get_sortable_items(self.locators.GRID_ITEM)
...
class SelectablePage(BasePage):
    ...
    def click_selectable_item(self, element):
        ...
        self.go_to_element(item_list[2])
...
class DroppablePage(BasePage):
    ...
    def drop_accept(self):
        ...
        self.go_to_element(acceptable_div)
...
class DraggablePage(BasePage):
    ...
    def get_before_and_after_positions(self, drag_element):
        self.go_to_element(drag_element)
    ...
    def get_top_position(self, positions):
        return re.findall(r'\d+', positions)[1]

    def get_left_position(self, positions):
        return re.findall(r'\d+', positions)[0]
