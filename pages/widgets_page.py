...
class AutoCompletePage(BasePage):
    ...
    def check_color_in_single(self):
        color = self.element_is_visible(self.locators.VALUE)
        return color.text
...
class ToolTipsPage(BasePage):
    ...
    def get_text_from_tool_tips(self, hover_elem, wait_elem):
        ...
        self.element_is_visible(wait_elem, 6)
        tool_tip_text = self.element_is_visible(self.locators.TOLL_TIPS_INNERS)
