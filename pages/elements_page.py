...
class TextBoxPage(BasePage):
    ...
    def check_filled_form(self):
        ...
        current_address = self.element_is_present(self.locators.CREATED_CURRENT_ADDERSS).text.split(":")[1]
...
class CheckBoxPage(BasePage):
    ...
    def get_checked_checkboxes(self):
        ...
        for box in checked_list:
            title_item = box.find_element(by=By.XPATH, value=self.locators.TITLE_ITEMS)
...
class RadioButtonPage(BasePage):
    ...
    def click_on_the_radiobutton(self, choice):
        ...
        elem = self.element_is_visible(choices[choice])
...
class WebTablePage(BasePage):
    ...
    def update_person_info(self):
        person_info = next(generated_person())
        age = person_info.age
        update_button = self.element_is_visible(self.locators.UPDATE_BUTTON)
        self.go_to_element(update_button)
        update_button.click()
        pole_age_input = self.element_is_visible(self.locators.AGE_INPUT)
        pole_age_input.clear()
        pole_age_input.send_keys(age)
        self.element_is_visible(self.locators.SUBMIT).click()
        return str(age)
...
class LinksPage(BasePage):
    ...
    def check_new_tab_limple_link(self):
    ...
    def check_brocken_link(self, url):
...
class UploadAndDownloadPage(BasePage):
    ...
    def download_file(self):
        ...
        path_name_file = fr'C:\Users\user\PycharmProjects\SeleniumPyTest\filetest{random.randint(0, 999)}.jpg'
...
class DynamicPropertiesPage(BasePage):
    ...
    def check_appearce_button(self):
        try:
            self.element_is_visible(self.locators.VISIBLE_AFTER_FIVE_SECONDS, 1)
        except TimeoutException:
            return False
        return True
