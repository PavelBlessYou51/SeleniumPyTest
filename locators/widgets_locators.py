...
class AccordianPageLocators:
    ...
    SECTION_SECOND_CONTENT = (By.CSS_SELECTOR, 'div[id="section2Heading"]')
    SECTION_THIRD = (By.CSS_SELECTOR, 'div[id="section3Heading"]')
    SECTION_THIRD_CONTENT = (By.CSS_SELECTOR, 'div[id="section3Heading"]')
...
class AutoCompletePageLocators:
    ...
    VALUE = (By.CSS_SELECTOR, 'div[class="auto-complete__single-value css-1uccc91-singleValue"')
...
class ToolTipsPageLocators:
    ...
    TOLL_TIPS_INNERS = (By.CSS_SELECTOR, 'div[class="tooltip-inner"]')
